...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole, Ownable {
  ...
  // Define enum 'State' with the following values:
    ...
    State constant DEFAULT_STATE = State.Harvested;

  // Define a struct 'Item' with the following fields:
    struct Item {
        uint    sku;  // Stock Keeping Unit (SKU)
        uint    upc; // Universal Product Code (UPC), generated by the Farmer, can be verified by the Consumer
        address payable ownerID;  // address of the current owner as the product moves through 8 stages
